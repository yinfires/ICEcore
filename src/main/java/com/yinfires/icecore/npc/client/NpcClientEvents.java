...
import com.yinfires.icecore.compat.cozycafe.seating.client.CozyCafeSeatAnchorRenderer;
...
public final class NpcClientEvents {
    ...
    @SubscribeEvent public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ModEntities.COZY_CAFE_SEAT.get(), CozyCafeSeatAnchorRenderer::new);
    }
}
